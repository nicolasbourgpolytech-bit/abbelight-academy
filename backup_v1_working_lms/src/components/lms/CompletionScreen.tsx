...
import Confetti from "react-confetti"; // Just kidding, we'll do CSS animation or assume it's there
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-8 animate-fade-in text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
                <div className="inline-block p-4 rounded-full bg-gradient-to-br from-primary to-yellow-300 mb-6 shadow-[0_0_40px_rgba(var(--primary-rgb),0.5)] animate-bounce-slow">
