            ...
            <div className="flex-1 flex flex-col bg-gray-900/50 relative">
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    {activeChapter.type === 'slides' && (
                        <div className="w-full h-full flex flex-col items-center justify-center p-8">
                            <div className="w-full max-w-4xl bg-white aspect-[4/3] rounded shadow-xl flex items-center justify-center text-black">
                                <div className="text-center">
                                    <h2 className="text-4xl font-bold mb-4">Slide Viewer</h2>
                                    <p className="text-gray-600">Rendering PDF/PPT content...</p>
                                    <p className="text-sm text-gray-400 mt-2">(Mock Placeholder)</p>
                                </div>
                            </div>
                        </div>
                    )}
                ...
                <div className="h-20 border-t border-white/10 bg-black flex items-center justify-between px-8">
                    ...
                    <button
                        ...
                        className="px-8 py-3 bg-primary text-black rounded-lg font-bold uppercase text-xs flex items-center gap-2 hover:bg-white transition-colors shadow-[0_0_20px_rgba(var(--primary-rgb),0.3)]"
                    >
