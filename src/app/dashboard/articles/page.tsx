    ...
    const filteredAndSortedArticles = useMemo(() => {
        ...
        if (search.trim()) {
            ...
            result = result.filter(a =>
                ...
                (a.firstAuthor && a.firstAuthor.toLowerCase().includes(q)) ||
                (a.lastAuthor && a.lastAuthor.toLowerCase().includes(q)) ||
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="relative w-full aspect-[32/9] min-h-[300px] rounded-2xl overflow-hidden mb-8 border border-white/10 shadow-2xl group">
                ...
                {/* Content */}
                <div className={`absolute inset-0 p-6 md:p-10 flex flex-col items-start z-10 ${isAdmin ? 'justify-between' : 'justify-center'}`}>
